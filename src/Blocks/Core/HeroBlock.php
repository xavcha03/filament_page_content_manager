    ...
    public static function getMcpFields(): array
    {
        return [
            ...
            [
                ...
                'type' => 'integer',
                'required' => false,
                'description' => 'ID MediaFile (uploader via Filament avant usage, variante hero)',
            ],
            [
                'name' => 'image_fond_alt',
                'label' => 'Texte alternatif de l\'image de fond',
                'type' => 'string',
                'required' => false,
                'description' => 'Texte alternatif personnalisé (variante hero)',
                'max_length' => 200,
            ],
            [
                'name' => 'image_fond',
                'label' => 'Image de fond (legacy)',
                'type' => 'string',
                'required' => false,
                'description' => 'Legacy — préférer image_fond_id',
            ],
            [
                'name' => 'images_ids',
                'label' => 'Images de la galerie',
                'type' => 'array',
                'required' => false,
                'description' => 'Liste d\'IDs MediaFile (variante projects)',
            ],
            [
