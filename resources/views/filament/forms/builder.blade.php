...
{{--
    Vue Builder custom : ouvre une Action modale (pas le dropdown block-picker).
--}}
                                ...
                                <div class="fi-fo-builder-add-between-items">
                                    <div
                                        @class([
                                            ...
                                            ($addActionAlignment instanceof Alignment) ? ('fi-align-' . $addActionAlignment->value) : $addActionAlignment => $addActionAlignment,
                                        ])
                                    >
